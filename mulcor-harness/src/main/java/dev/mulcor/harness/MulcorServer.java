...
/**
 * A Mulcor server that real Minecraft clients can join (offline mode, creative, flat world).
 *
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (Engine engine = new Engine(cfg)) {
            ...
            try (NetServer net = NetServer.vanilla(port, io, ctx)) {
                System.out.printf("Mulcor listening on port %d (%s transport): Minecraft %s, protocol %d, offline mode%n",
